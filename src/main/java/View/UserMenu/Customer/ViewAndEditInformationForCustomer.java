...
public class ViewAndEditInformationForCustomer extends Menu {
    public ViewAndEditInformationForCustomer(Menu parentMenu) {
        super(parentMenu);
    }
    @Override
    public void help() {
    ...
    public void execute() {
        ...
        System.out.println(customer.viewPersonalInfo());
        String command;
