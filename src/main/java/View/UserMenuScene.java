...
//      bottomGridPane.setStyle("-fx-background-color: rgba(45, 156, 240, 1);");
    ...
    private void setUpGridPane() {
        ...
        upGridPane.getRowConstraints().add(new RowConstraints(45, Control.BASELINE_OFFSET_SAME_AS_HEIGHT, 45, Priority.NEVER, VPos.CENTER, true));
        upGridPane.add(label, 0, 0);
    }

    private void setPageGridPain() {
        pageGridPane.getRowConstraints().add(new RowConstraints(45, Control.BASELINE_OFFSET_SAME_AS_HEIGHT, 45, Priority.NEVER, VPos.CENTER, false));
        pageGridPane.getRowConstraints().add(new RowConstraints(40, Control.USE_COMPUTED_SIZE, 40, Priority.NEVER, VPos.TOP, true));
        pageGridPane.getRowConstraints().add(new RowConstraints(80, Control.USE_COMPUTED_SIZE, Double.POSITIVE_INFINITY, Priority.NEVER, VPos.TOP, true));
