...
public class MessageController {
    ...
    public void processMessage(String message) {
        if (message.startsWith("@Error@")) {
            ...
            ClientController.getInstance().getCurrentMenu().showMessage("Successfully purchase", MessageKind.MessageWithoutBack);
            ...
            ClientController.getInstance().getCurrentMenu().showMessage("Login successful", MessageKind.MessageWithoutBack);
            ...
            ClientController.getInstance().getCurrentMenu().showMessage(message.substring(17, message.length()), MessageKind.MessageWithoutBack);
            ...
            ClientController.getInstance().getCurrentMenu().showMessage("Category created", MessageKind.MessageWithoutBack);
